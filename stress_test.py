...
print('\n✅ STRESS TEST: Running 20 iterations to verify robustness')
print('=' * 70)
...
for i in range(20):
    ...
    pct = (num_valid / 250) * 100
    print(f'Iteration {i+1:2d}: {num_valid:3d}/250 ({pct:5.1f}%) {status}')
    if num_valid == 0:
        print('    ^^^ CRITICAL: 0/250 FAILURE - BUG STILL EXISTS!')
        all_passed = False

print('=' * 70)
if all_passed:
    print('✅ SUCCESS: All 20 iterations passed with 100% success rate!')
